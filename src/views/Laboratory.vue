    ...
    <div class="right">
      ...
      <div :style="mem5" class="picc" style="margin-top:-80%">
        ...
        <div style="margin-top:-63%;font-family:FangSong;margin-left:11%;">
          <p class="pos">地点:</p>
          <p style="width:36.6%">重庆市巴南区红光大道69号</p>
          <p style="width:36.6%;height:20px">
            重庆理工大学花溪校区第四教学楼306
          </p>
          <img :src="pic5" style="margin-top:20px;width:36%;margin-left:-1%;" />
          <div style="margin-top:-47%;margin-left:54%;">
            <img :src="pic6" style="width:70%;" />
          </div>
          <div style="margin-top:5%;margin-left:54%;">
            <img :src="pic7" style="width:70%;" />
          </div>
        </div>
      </div>
      <div :style="mem6" class="picc" style="margin-top:-50.5%">
        ...
        <div style="margin-top:-60%;font-family:FangSong;margin-left:6%;">
          ...
          <div
            style="width:48%;margin-top:10%;margin-left:-6%;font-size:100%;height:250px"
          >
            计算思维是一种对解决问题非常有效的特殊思维方式，适用范围很广。每个学科都应该包含一种计算思维方法。
          ...
          <div class="aaa">
            <p class="dic">研究方向:</p>
            <p class="dicc">
              算法和编程、<br />数据表证与结构、<br />计算过程和硬件、<br />通信和网络以及交互、<br />系统和社会
            </p>
          </div>
        </div>
      </div>
      <div :style="mem7" class="picc3">
        ...
        <div style="margin-top:-70%;font-family:FangSong;margin-left:10%;">
          ...
          <p
            style="font-size:100%;margin-top:5em;margin-left:-10%;width:48%;height:250px"
          >
          ...
          <router-link to="member">
            <p
              style="font-family:SimSun;font-size:110%;margin-top:5%;margin-left:20%"
            >
              更多人员 >>
            </p>
          </router-link>
          <div style="margin-top:-373px;margin-left:65%">
            <img :src="pic8" style="width:150%;" />
          </div>
        </div>
      </div>
    </div>
